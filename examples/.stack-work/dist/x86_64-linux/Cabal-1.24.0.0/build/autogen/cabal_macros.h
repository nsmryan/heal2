...
/* package heal-examples-0.1.0.0 */
#define VERSION_heal_examples "0.1.0.0"
#define MIN_VERSION_heal_examples(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package heal-0.1.0.0 */
#define VERSION_heal "0.1.0.0"
#define MIN_VERSION_heal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "heal-examples-0.1.0.0"

#define CURRENT_PACKAGE_KEY "heal-examples-0.1.0.0"
